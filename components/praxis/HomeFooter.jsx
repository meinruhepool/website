...
export default function HomeFooter({navLinks, onNavLinkClick}) {
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
            ...
            <ul className="space-y-2.5">
              {navLinks.map((link) => (
                ...
                <button
                  ...
                  className="cursor-pointer text-sm font-light text-primary-foreground/50 hover:text-primary-foreground/80 transition-colors"
                >
                  {link.label}
                </button>
              </li>
        ...
        <div className="border-t border-primary-foreground/10 pt-8 text-center">
          <p className="text-xs font-light text-primary-foreground/35">
            © {currentYear} {PRACTICE.name} — {PRACTICE.fullName} Alle Rechte
            vorbehalten.
          </p>
        </div>
      </div>
